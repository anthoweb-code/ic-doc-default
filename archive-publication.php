								...
								<header class="article-header">
									...
									<h2>
										<a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php 
											  echo get_post_meta( $post->ID, 'wpcf-person-title', true )." "
											  	  .get_post_meta( $post->ID, 'wpcf-person-first-name', true )." "
											  	  .get_post_meta( $post->ID, 'wpcf-person-middle-name', true )." "
											  	  .get_post_meta( $post->ID, 'wpcf-person-last-name', true );
										?></a>
										<span></span>
									</h2>
